export type Project = {
  title: string; slug: string; location: string; year: string; category: string;
  area: string; client: string; status: string; concept: string; description: string;
...
export const projects: Project[] = [
  {
    title: 'Casa Verde Residence', slug: 'casa-verde', location: 'Pampanga, Philippines', year: '2026', category: 'Residential', area: '620 sqm', client: 'Private Residence', status: 'Completed',
  ...
  {
    title: 'Courtyard House', slug: 'courtyard-house', location: 'Tarlac, Philippines', year: '2025', category: 'Residential', area: '410 sqm', client: 'Private Residence', status: 'Completed',
  ...
  {
    title: 'Northline Corporate Center', slug: 'northline-center', location: 'Clark, Pampanga', year: '2026', category: 'Commercial', area: '8,400 sqm', client: 'Northline Holdings', status: 'Under Construction',
  ...
  {
    title: 'Solana Resort Villas', slug: 'solana-villas', location: 'Zambales, Philippines', year: '2025', category: 'Hospitality', area: '3.2 ha', client: 'Solana Leisure Group', status: 'Completed',
  ...
  {
    title: 'Atelier House', slug: 'atelier-house', location: 'Quezon City, Philippines', year: '2026', category: 'Interior Design', area: '285 sqm', client: 'Private Residence', status: 'Completed',
  ...
  {
    title: 'Heritage Residence Renovation', slug: 'heritage-residence', location: 'San Fernando, Pampanga', year: '2025', category: 'Renovation', area: '530 sqm', client: 'Private Residence', status: 'Completed',
